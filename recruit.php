...
?>
	...
	<html class="fixed">
		<head>
			<!-- Basic -->
			<meta charset="UTF-8">
			<title>WorkSpace | Vendor Recruitment</title>
		...
		<body>
			<section class="body">
				...
				<div class="inner-wrapper">
					...
					<!-- end: sidebar -->
                    <?php if (login_check($mysqli) == true && !check_access(5)) : ?>
					<section role="main" class="content-body">
						...
						<?php
                            ...
                            $xcrud->table_name('Online Submission & In-Processing');
                            $xcrud->table('tblVendors');
                            $xcrud->default_tab('Company Info');
                            $xcrud->where('VendorStatus', array('13','12'));
                            ...
                            $xcrud->order_by('Received_Date','desc');
                        	if (check_access(5)){
                        		$xcrud->unset_add();
                        		$xcrud->unset_edit();
                        		$xcrud->unset_remove();
