									...
									<section class="panel">
										...
										<div class="panel-body">
                                            <div class="alert alert-info fade in nomargin">
        										...
        										<p>Please complete the information below to request a <strong class="text-danger">new vendor</strong>  from Vendor Management.</p>
    			                            </div>
											<div class="form-group">
												<label class="col-md-7 control-label">Name of US Best Repairs Coordinator requesting vendor <span class="required">*</span></label>
												<div class="col-md-4 mb-xs">
													<div class="input-group input-group-icon">
														<span class="input-group-addon">
															<span class="icon"><i class="fa fa-user"></i></span>
														</span>
														<input class="form-control" placeholder="Coordinator" type="text">
													</div>
												</div>
												<label class="col-md-7 control-label">Name of Requested Client <span class="required">*</span></label>
												<div class="col-md-4  mb-xs">
													<div class="input-group input-group-icon">
														<span class="input-group-addon">
															<span class="icon"><i class="fa fa-asterisk"></i></span>
														</span>
														<input class="form-control" placeholder="Requested Client" type="text">
													</div>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">Client W/O# <span class="required">*</span></label>
												<div class="col-md-4 mb-xs">
													<div class="input-group input-group-icon">
														<span class="input-group-addon">
															<span class="icon"><i class="fa fa-tags"></i></span>
														</span>
														<input class="form-control" placeholder="Work Order" type="text">
													</div>
												</div>
											...
											<div class="form-group">
    											...
    											<div class="col-md-4">
    												<select data-plugin-selectTwo class="form-control populate mb-xs">
												...
												<label class="col-md-1 control-label">City <span class="required">*</span></label>
												<div class="col-md-4 mb-xs">
													<div class="input-group input-group-icon">
														<span class="input-group-addon">
											...
											<div class="form-group">
												...
												<label class="col-md-7 control-label">Type of Vendor Needed <span class="required">*</span></label>
												<div class="col-md-4 mb-xs">
												...
												<label class="col-md-7 control-label">Job Category/Type of Work <span class="required">*</span></label>
												<div class="col-md-4 mb-xs">
													<div class="input-group input-group-icon">
														<span class="input-group-addon">
															<span class="icon"><i class="fa fa-wrench"></i></span>
														</span>
														<input class="form-control" placeholder="Type of Work" type="text">
													</div>
												</div>
                                                <label class="col-md-2 control-label" for="textareaAutosize">Note</label>
												<div class="col-md-9">
